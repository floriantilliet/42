...
/*   Updated: 2024/10/13 20:20:01 by florian          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
    ...
    t_tuple vector1 = create_vector(0,-1,0);
    t_tuple vector2 = create_vector(sqrt(2)/2,sqrt(2)/2,0);
    t_tuple vector3 = sphere_reflect(vector1, vector2);
